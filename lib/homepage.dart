...
import 'package:flutter_cv/personalInfo.dart';
import 'package:flutter_cv/skill.dart';
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.bold,
                color: Colors
                    .white, // Change color to black for better readability
              ),
            ),
            Column(
              children: <Widget>[
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text:
                            "   Designed and implemented network infrastructure improvements, enhancing network performance and reliability. ",
                        style: TextStyle(fontWeight: FontWeight.normal),
                      ),
                      TextSpan(
                        text:
                            "Configured and maintained Cisco routers and switches, optimizing data flow within the organization. ",
                        style: TextStyle(fontWeight: FontWeight.normal),
                      ),
                      TextSpan(
                        text:
                            "Implemented robust security measures, including firewalls and intrusion detection systems, reducing security threats by 25%.",
                        style: TextStyle(fontWeight: FontWeight.normal),
                      ),
                    ],
                  ),
