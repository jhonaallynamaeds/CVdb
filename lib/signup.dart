...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _signup() async {
    ...
    if (!_validatePassword(passwordController.text)) {
      setState(() {
        passwordErrorText = 'Password must contain special characters';
      });
      return;
    } else {
      setState(() {
    ...
    final response = await http.post(
      Uri.parse('http://localhost/jhona/signup.php'),
      body: {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Email',
                labelStyle: TextStyle(color: Color.fromARGB(255, 58, 58, 57)),
                errorText: usernameErrorText,
                prefixIcon: Icon(
                  Icons.email,
                  color: const Color.fromARGB(
                      255, 75, 74, 74), // Set icon color as per your design
                ),
              ),
              validator: (value) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(
                    Icons.email,
                    color: const Color.fromARGB(
                        255, 58, 58, 57), // Set icon color as per your design
                  ),
